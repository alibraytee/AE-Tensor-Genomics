...
```{r include = FALSE}
# Optional: depends on whether you want to see the original code and warning messages of R
...
1. Load dataset
```{r}
tucker=read.csv("/Users/vivit/73TrainGlioma/CP glioma 73 train rank9.csv",header=F)
clinical=read.csv("/Users/vivit/73TrainGlioma/train_clinical_G73_merged.csv",header=T,na.strings=" ")
```

2.  Further scale, this step is optional
```{r}
tucker1=scale(tucker)
```

3. Kmeans
3.1. Apply Kmeans for 2,3 and 4 groups 
```{r}
# apply Kmeans
library(flexclust)
...
# add kmeans results to the datasets
data1=clinical
...
3.2. Create the survival objects
```{r}
...
3.3. Fit the results of Kmeans of 2 groups 
```{r}
...
ggsurvplot(km_2,
            ...
            risk.table.height=.3)
```
3.4.Fit the results of Kmeans of 3 groups 
```{r}
...
ggsurvplot(km_3,
            ...
            risk.table.height=.3)
```
3.5. Fit the results of Kmeans of 4 groups 
```{r}
...
4.1.Apply all different combinations of distance measurement and linkage methods for Hierarchical clustering
```{r}
#Apply all different combinations of distance measurement and linkage methods for Hierarchical clustering
library(proxy)
...
# add all clustered results into the dataset
data1$euc_s2=euc_s2
data1$euc_c2=euc_c2
data1$euc_a2=euc_a2
data1$euc_w2=euc_w2
...
4.2.Fit the results of Hierarchical clustering
4.2.1. Euclidean distance measurement + Single Linkage 
```{r}
ggsurvplot(HC1,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW1,
           ...
           risk.table.height=.3)
```
4.2.2. Euclidean distance measurement + Average Linkage
```{r}
ggsurvplot(HC2,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW2,
           ...
           risk.table.height=.3)
```
4.2.3. Euclidean distance measurement + Complete Linkage
```{r}
ggsurvplot(HC3,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW3,
           ...
           risk.table.height=.3)
```
4.2.4. Euclidean distance measurement + Ward Linkage
```{r}
ggsurvplot(HC4,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW4,
           ...
           risk.table.height=.3)
```
4.2.5. Euclidean distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC5,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW5,
           ...
           risk.table.height=.3)
```
4.2.6. Euclidean distance measurement + Median Linkage
```{r}
ggsurvplot(HC6,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW6,
           ...
           risk.table.height=.3)
```
4.2.7. Euclidean distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC7,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW7,
           ...
           risk.table.height=.3)
```
4.2.8. Manhattan distance measurement + Single Linkage
```{r}
ggsurvplot(HC8,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW8,
           ...
           risk.table.height=.3)
```
4.2.9. Manhattan distance measurement + Average Linkage
```{r}
ggsurvplot(HC9,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW9,
           ...
           risk.table.height=.3)
```
4.2.10. Manhattan distance measurement + Complete Linkage
```{r}
ggsurvplot(HC10,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW10,
           ...
           risk.table.height=.3)
```
4.2.11. Manhattan distance measurement + Ward Linkage
```{r}
ggsurvplot(HC11,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW11,
           ...
           risk.table.height=.3)
```
4.2.12. Manhattan distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC12,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW12,
           ...
           risk.table.height=.3)
```
4.2.13. Manhattan distance measurement + Median Linkage
```{r}
ggsurvplot(HC13,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW13,
           ...
           risk.table.height=.3)
```
4.2.14. Manhattan distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC14,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW14,
           ...
           risk.table.height=.3)
```
4.2.15. Jaccard distance measurement + Single Linkage
```{r}
ggsurvplot(HC15,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW15,
           ...
           risk.table.height=.3)
```
4.2.16. Jaccard distance measurement + Average Linkage
```{r}
ggsurvplot(HC16,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW16,
           ...
           risk.table.height=.3)
```
4.2.17. Jaccard distance measurement + Complete Linkage
```{r}
ggsurvplot(HC17,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW17,
           ...
           risk.table.height=.3)
```
4.2.18. Jaccard distance measurement + Ward Linkage
```{r}
ggsurvplot(HC18,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW18,
           ...
           risk.table.height=.3)
```
4.2.19. Jaccard distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC19,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW19,
           ...
           risk.table.height=.3)
```
4.2.20. Jaccard distance measurement + Median Linkage
```{r}
ggsurvplot(HC20,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW20,
           ...
           risk.table.height=.3)
```
4.2.21. Jaccard distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC21,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW21,
           ...
           risk.table.height=.3)
```
4.2.22. Maximum distance measurement + Single Linkage
```{r}
ggsurvplot(HC22,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW22,
           ...
           risk.table.height=.3)
```
4.2.23. Maximum distance measurement + Average Linkage
```{r}
ggsurvplot(HC23,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW23,
           ...
           risk.table.height=.3)
```
4.2.24. Maximum distance measurement + Complete Linkage
```{r}
ggsurvplot(HC24,
           pval=T,
           risk.table=T,
...
```
4.2.25. Maximum distance measurement + Ward Linkage
```{r}
ggsurvplot(HC25,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW25,
           ...
           risk.table.height=.3)
```
4.2.26. Maximum distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC26,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW26,
           ...
           risk.table.height=.3)
```
4.2.27. Maximum distance measurement + Median Linkage
```{r}
ggsurvplot(HC27,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW27,
           ...
           risk.table.height=.3)
```
4.2.28. Maximum distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC28,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW28,
           ...
           risk.table.height=.3)
```
4.2.29. Binary distance measurement + Single Linkage
```{r}
ggsurvplot(HC29,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW29,
           ...
           risk.table.height=.3)
```
4.2.30. Binary distance measurement + Average Linkage
```{r}
ggsurvplot(HC30,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW30,
           ...
           risk.table.height=.3)
```
4.2.31. Binary distance measurement + Complete Linkage
```{r}
ggsurvplot(HC31,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW31,
           ...
           risk.table.height=.3)
```
4.2.32. Binary distance measurement + Ward Linkage
```{r}
ggsurvplot(HC32,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW32,
           ...
           risk.table.height=.3)
```
4.2.33. Binary distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC33,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW33,
           ...
           risk.table.height=.3)
```
4.2.34. Binary distance measurement + Median Linkage
```{r}
ggsurvplot(HC34,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW34,
           ...
           risk.table.height=.3)
```
4.2.35. Binary distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC35,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW35,
           ...
           risk.table.height=.3)
```
4.2.36. Canberra distance measurement + Single Linkage
```{r}
ggsurvplot(HC36,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW36,
           ...
           risk.table.height=.3)
```
4.2.37. Canberra distance measurement + Average Linkage
```{r}
ggsurvplot(HC37,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW37,
           ...
           risk.table.height=.3)
```
4.2.38. Canberra distance measurement + Complete Linkage
```{r}
ggsurvplot(HC38,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW38,
           ...
           risk.table.height=.3)
```
4.2.39. Canberra distance measurement + Ward Linkage
```{r}
ggsurvplot(HC39,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW39,
           ...
           risk.table.height=.3)
```
4.2.40. Canberra distance measurement + Mcquitty Linkage
```{r}
ggsurvplot(HC40,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW40,
           ...
           risk.table.height=.3)
```
4.2.41. Canberra distance measurement + Median Linkage
```{r}
ggsurvplot(HC41,
           pval=T,
           risk.table=T,
...
ggsurvplot(HW41,
           ...
           risk.table.height=.3)
```
4.2.42. Canberra distance measurement + Centroid Linkage
```{r}
ggsurvplot(HC42,
           pval=T,
           risk.table=T,
...
```
6.1. Fit the EM algorithm for 2 groups
```{r}
...
ggsurvplot(eml1,
           ...
           risk.table.height=.3)
```
6.2. Fit the EM algorithm for 3 groups
```{r}
...
ggsurvplot(eml2,
           ...
           risk.table.height=.3)
```
6.3. Fit the EM algorithm for 4 groups
```{r}
