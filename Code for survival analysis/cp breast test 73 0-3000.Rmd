...
```{r}
tucker=read.csv("/Users/vivit/73TestBreast/CP breast 73 test rank9.csv",header=F)
clinical=read.csv("/Users/vivit/73TestBreast/test_clinical_B73_merged.csv",header=T,na.strings=" ")
```
